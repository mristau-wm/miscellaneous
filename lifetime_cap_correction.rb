...
# - Production (2022-02-07): https://gist.github.com/mristau-wm/dd4c69f46a3b4d462ac64729b33120d6#file-production-2022-02-07
...
Advertising::Flight.find_each do |flight|
  ...
  puts "CSV summary: #{flight.id},#{adjustment_amount},#{adjustment_type},#{current_lifetime_cap},#{accurate_lifetime_cap},#{initial_lifetime_cap},#{flight.lifetime_cap},#{flight.balance},#{flight.revenue_from_deltas}"
rescue => e
